...
export default function ChatWidget() {
  ...
  const [messages, setMessages] = useState([
    { role: 'assistant', text: "Hey! I'm the VT Food Pantry assistant! How can I help you today?" }
  ]);
    ...
    <>
      ...
      <style jsx>{`
        .chat-fab {
          ...
          background: #861f41; color: #fff; font-size: 1.6rem;
          border: none; cursor: pointer;
          box-shadow: 0 4px 24px rgba(134,31,65,0.4);
          z-index: 200; transition: transform 0.15s, background 0.15s;
        ...
        .chat-header {
          background: #861f41; color: #fff; padding: 14px 16px;
        ...
        .chat-title { font-weight: 700; font-size: 0.95rem; margin: 0; }
        .chat-subtitle { font-size: 0.72rem; opacity: 0.8; margin: 0; }
        .chat-close {
        ...
        .chat-input-row button {
          padding: 9px 14px; background: #861f41; color: #fff;
