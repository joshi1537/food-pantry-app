  ...
  return (
    <div className="page">
      ...
      <style jsx>{`
        ...
        .table-wrap { padding: 28px 36px; overflow-x: auto; }
        ...
        .td-note { color: #6b7280; font-style: italic; max-width: 200px; }
        .qty-badge { display: inline-block; padding: 2px 10px; background: #f3f4f6; border-radius: 999px; font-weight: 700; font-size: 0.82rem; }
        ...
        .modal-box { background: #fff; border-radius: 14px; width: 100%; max-width: 500px; max-height: 90vh; overflow-y: auto; box-shadow: 0 20px 60px rgba(0,0,0,0.25); }
